...
void sendSMS()
{
 ...
 // SMARTWeatherAlert.println("AT + CMGS = \"+639397004779\"");                                     // recipient's mobile number, in international format
  ...
  //1)Proximity
  SMARTWeatherAlert.println("Water level (inch):");        
  delay(100);
  SMARTWeatherAlert.println(waterlevelinches);       
  delay(100);
  SMARTWeatherAlert.println("Water level (cm):");       
  delay(100);
  SMARTWeatherAlert.println(waterlevelcm);  
  delay(100);
  ...
  //4)Vibration
  SMARTWeatherAlert.println("Vibration:");
  SMARTWeatherAlert.println(measurement);
  if (measurement > 10){
